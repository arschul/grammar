...
At night, I put my phone on my desk to charge. My parents always say I use my phone too much. Maybe they are right! But it is very useful. I cannot imagine my life without my smartphone.`
  ...
  // ── 4. FOOD ──────────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'olive oil', definition: 'a liquid fat made from olives, used in cooking' },
...
David thinks a good morning routine is very important for a happy day.`
  ...
  // ── 6. HEALTH ────────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      { word: 'healthy', definition: 'good for your body; helping you stay well' },
      { word: 'walk', definition: 'to move on foot at a regular pace' },
...
Carlos says football is more than a sport. It is a way to make friends and have fun together.`
  ...
  // ── 8. NATURE ────────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'leaves', definition: 'the flat green parts of trees that change colour in autumn' },
...
The forest is a quiet place. There are no cars or noise. I feel calm and relaxed when I am there. I think it is important to have nature near where we live.`
  ...
  // ── 9. MOVIES & SERIES ───────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'service', definition: 'a system that provides something useful, like streaming films' },
      ...
      { word: 'turn', definition: 'each person\'s chance to do something in a group' },
    ],
    questions: [
...
Shopping usually takes about forty-five minutes. She goes home, puts everything away, and makes a cup of tea. She says Sunday shopping is a very calm and satisfying activity.`
  ...
  // ── 12. ANIMALS & PETS ───────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'water', definition: 'the clear liquid that animals and people need to drink' },
    ],
    questions: [
...
I love Luna very much. She is good company, especially when I am alone at home.`
  ...
  // ── 13. EDUCATION ────────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'speaking', definition: 'the act of using your voice to communicate in a language' },
...
Sometimes I worry about spending too much time online. It is important to take breaks and spend time away from screens. Balance is the key.`
  ...
  // ── 16. HOLIDAYS & CELEBRATIONS ──────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      { word: 'memories', definition: 'things from the past that you remember' },
      { word: 'hugs', definition: 'when you put your arms around someone to show you care' },
      ...
      { word: 'grateful', definition: 'feeling happy and thankful for something good in your life' },
    ],
    questions: [
